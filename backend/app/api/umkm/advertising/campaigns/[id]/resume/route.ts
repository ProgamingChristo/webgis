...
export async function POST(
  req: NextRequest,
  { params }: RouteContext<"/api/umkm/advertising/campaigns/[id]/resume">
  ...
  return withApiLogger(req, reqId, async () => {
    ...
    const result = await service.resumeCampaign(merchantId, campaignId);

    return createSuccessResponse(reqId, result);
  });
}

export const OPTIONS = createOptionsHandler("/api/umkm/advertising/campaigns/[id]/resume");
