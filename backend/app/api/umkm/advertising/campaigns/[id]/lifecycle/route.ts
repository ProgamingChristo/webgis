...
export async function GET(
  ...
  return withApiLogger(req, reqId, async () => {
    ...
    const result = await service.getLifecycleState(merchantId, campaignId);

    return createSuccessResponse(reqId, result);
  });
}

export const OPTIONS = createOptionsHandler("/api/umkm/advertising/campaigns/[id]/lifecycle");
