DROP FUNCTION IF EXISTS public.create_community_contribution_v1(
  TEXT,
  DOUBLE PRECISION,
  DOUBLE PRECISION,
  TIMESTAMPTZ,
...
BEGIN
  ...
  SELECT
    ...
    contribution.status,
    contribution.location_longitude,
    contribution.location_latitude,
    contribution.observed_at,
    contribution.report_data,
    contribution.target_merchant_id,
    contribution.reported_new_longitude,
    contribution.reported_new_latitude,
    contribution.submitted_at,
    contribution.created_at,
    contribution.updated_at,
    contribution.reviewed_at,
    contribution.review_reason
  FROM public.get_community_contribution_v1(inserted_id) AS contribution;
END;
$$;
