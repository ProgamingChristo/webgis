...
export function BusinessSpaceChart({ option, label }: { option: EChartsOption; label: string }) {
  ...
  return <div ref={element} className="business-space-chart" role="img" aria-label={label} />;
}
