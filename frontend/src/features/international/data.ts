...
export const INTERNATIONAL_FEATURES: InternationalFeatureMeta[] = [
  // 1-10
  { slug: "cctv", title: "Global Traffic & CCTV Live Feed", description: "Streaming sensor CCTV global dengan AI counter kendaraan & pejalan kaki.", category: "safety", iconName: "Video", badge: "Live AI" },
  { slug: "traffic-congestion", title: "Pendeteksi Macet & Rekayasa Arus", description: "Deteksi bottleneck jalan raya, kecepatan rata-rata & rekomendasi jalan tikus.", category: "mobility", iconName: "Car", badge: "Realtime" },
  { slug: "multimodal-transit", title: "Perencana Rute Lintas Batas", description: "Kombinasi kereta cepat, metro, bus, sepeda & jalan kaki internasional.", category: "mobility", iconName: "Plane", badge: "Global Routing" },
  { slug: "air-quality", title: "Kualitas Udara & Indeks Mikroklimat", description: "Sensor PM2.5, PM10, suhu serta koridor jalan kaki rendah polusi.", category: "environment", iconName: "Wind", badge: "Sensor Net" },
  { slug: "urban-heat", title: "Pulau Panas Kota & Keteduhan Kanopi", description: "Peta suhu permukaan satelit & jalur rindang pelindung pejalan kaki.", category: "environment", iconName: "Sun", badge: "Satellite" },
  { slug: "elevation-profile", title: "Profil Ketinggian & Kemiringan Tanjakan", description: "Analisis elevasi DEM untuk kursi roda, pejalan kaki lansia & pesepeda.", category: "mobility", iconName: "TrendingUp", badge: "DEM GIS" },
  { slug: "smart-parking", title: "Sensor Parkir Cerdas & Okupansi Curbside", description: "Ketersediaan slot parkir mobil, motor, disabilitas & charging EV.", category: "smart-city", iconName: "ParkingCircle", badge: "IoT Sensor" },
  { slug: "ev-charging", title: "Stasiun Pengisian Kendaraan Listrik (EV)", description: "Jaringan SPKLU internasional, daya kW, status soket & tarif per kWh.", category: "smart-city", iconName: "Zap", badge: "Clean Energy" },
  { slug: "noise-pollution", title: "Peta Kebisingan Akustik Kota", description: "Pemantauan desibel (dB) jalan raya, zona tenang & regulasi polusi suara.", category: "environment", iconName: "Volume2", badge: "Acoustics" },
  { slug: "flood-monitoring", title: "Sistem Telemetri Banjir & Elevasi Air", description: "Peringatan dini luapan sungai, pompa pengendali & zona genangan.", category: "safety", iconName: "Waves", badge: "Telemetry" },

  // 11-20
  { slug: "solar-radiation", title: "Simulasi Bayangan Gedung & Radiasi Matahari", description: "Prediksi bayangan arsitektur untuk kenyamanan termal pejalan kaki.", category: "environment", iconName: "SunDim", badge: "Solar 3D" },
  { slug: "emergency-evacuation", title: "Rute Evakuasi Bencana & Titik Kumpul", description: "Jalur evakuasi terpendek menuju shelter gempa, tsunami & darurat sipil.", category: "safety", iconName: "ShieldAlert", badge: "Resilience" },
  { slug: "micromobility", title: "Ketersediaan Sepeda & Skuter Sewa", description: "Peta armada bike-share real-time, sisa baterai & zona parkir geofence.", category: "mobility", iconName: "Bike", badge: "Fleet GPS" },
  { slug: "gtfs-realtime", title: "Pelacak Posisi Bus & Kereta GTFS-RT", description: "Telemetri armada transportasi umum live, headway & prediksi kedatangan.", category: "mobility", iconName: "Train", badge: "GTFS Feed" },
  { slug: "walk-score", title: "Kalkulator Walk Score Kota 15 Menit", description: "Metrik kelayakan jalan kaki 0-100 berdasarkan akses fasilitas esensial.", category: "smart-city", iconName: "Footprints", badge: "15-Min City" },
  { slug: "tourist-audio-guide", title: "Panduan Suara Wisata Multibahasa", description: "Titik geofence audio guide otomatis untuk turis mancanegara.", category: "commerce", iconName: "Headphones", badge: "Audio Guide" },
  { slug: "currency-tax-refund", title: "Konversi Valas & Kalkulator Tax Refund", description: "Panduan refund PPN / VAT turis dan konversi harga belanja pasar lokal.", category: "commerce", iconName: "Coins", badge: "Fintech" },
  { slug: "market-translator", title: "Penerjemah Tawar-Menawar & Alergi Makanan", description: "Kartu alergi diet & frase tawar-menawar pasar tradisional 8 bahasa.", category: "commerce", iconName: "Languages", badge: "AI Translate" },
  { slug: "carbon-marketplace", title: "Bursa Kredit Karbon Pejalan Kaki", description: "Monetisasi jejak langkah terverifikasi menjadi token ESG & offset.", category: "commerce", iconName: "Leaf", badge: "Green Credit" },
  { slug: "digital-twin-3d", title: "Digital Twin 3D & Ekstrusi Bangunan", description: "Visualisasi LoD2 poligon bangunan kota, ketinggian & tutupan lahan.", category: "smart-city", iconName: "Box", badge: "LoD2 3D" },

  // 21-30
  { slug: "road-damage-ai", title: "Inspeksi Kerusakan Jalan & Trotoar AI", description: "Deteksi visual otomatis lubang aspal, retak & penutup utilitas ambles.", category: "smart-city", iconName: "ScanLine", badge: "Vision AI" },
  { slug: "drone-corridors", title: "Koridor Logistik Drone & Zona Udara Rendah", description: "Peta no-fly zone, vertiport komersial & koridor pengiriman udara aman.", category: "logistics", iconName: "Radio", badge: "Airspace" },
  { slug: "port-logistics", title: "Terminal Logistik Pelabuhan & Multimoda", description: "Waktu tunggu kontainer TEU, jalur kapal & interkoneksi rel kargo.", category: "logistics", iconName: "Anchor", badge: "Freight" },
  { slug: "historical-map", title: "Morfologi Sejarah Kota & Citra Satelit", description: "Time-slider perbandingan perluasan kota dari 1970 hingga modern.", category: "governance", iconName: "Clock", badge: "Temporal GIS" },
  { slug: "spatial-demographics", title: "Demografi Spasial & Daya Beli Kawasan", description: "Kepadatan penduduk, rasio usia produktif & pergerakan komuter harian.", category: "governance", iconName: "Users", badge: "Census GIS" },
  { slug: "public-wifi", title: "Jaringan Wi-Fi Publik & Kios Informasi", description: "Titik koneksi internet kota gratis, kecepatan Mbps & jangkauan sinyal.", category: "smart-city", iconName: "Wifi", badge: "Connectivity" },
  { slug: "green-spaces", title: "Ruang Terbuka Hijau & Indeks Biofilia", description: "Akses taman dalam radius 300 meter, skor tutupan vegetasi & satwa.", category: "environment", iconName: "Trees", badge: "Biophilia" },
  { slug: "cultural-heritage", title: "Rute Monumen Budaya & Warisan Dunia", description: "Situs cagar budaya UNESCO, sejarah arsitektur & konservasi fasad.", category: "governance", iconName: "Landmark", badge: "Heritage" },
  { slug: "water-refill", title: "Titik Isi Ulang Air Minum Publik Bebas Sampah", description: "Peta air minum gratis isi ulang higienis pengurang botol plastik.", category: "environment", iconName: "Droplet", badge: "Zero Waste" },
  { slug: "accessible-restrooms", title: "Pencari Toilet Difabel & Sanitasi Publik", description: "Fasilitas sanitasi ramah kursi roda, ruang laktasi & rating kebersihan.", category: "safety", iconName: "Sparkles", badge: "Inclusive" },

  // 31-40
  { slug: "street-lighting", title: "Jaringan Penerangan Jalan Cerdas (PJU)", description: "Telemetri tiang lampu pintar, intensitas lux penerangan & titik gelap.", category: "safety", iconName: "Lightbulb", badge: "Smart Grid" },
  { slug: "incident-dispatch", title: "Pusat Komando Insiden & Armada Darurat", description: "Pelacakan ambulans, pemadam kebakaran & prioritas koridor lampu hijau.", category: "safety", iconName: "Siren", badge: "Emergency" },
  { slug: "commuter-crowding", title: "Prediksi Kepadatan Gerbong Kereta", description: "Sensor beban penumpang per gerbong kereta & saran posisi tunggu peron.", category: "mobility", iconName: "Users2", badge: "Transit AI" },
  { slug: "weather-radar", title: "Radar Doppler Presipitasi & Angin Kencang", description: "Nowcasting hujan badai lokal 10 menit & peringatan angin terowongan.", category: "environment", iconName: "CloudRain", badge: "Doppler" },
  { slug: "curbside-management", title: "Manajemen Dinamis Tepi Jalan & Drop-off", description: "Zonasi adaptif bongkar muat pagi, parklet makan siang & ride-hail malam.", category: "smart-city", iconName: "Maximize2", badge: "Curbside" },
  { slug: "waste-recycling", title: "Sensor Tempat Sampah Pintar & Bank Sampah", description: "Level kepenuhan bin ultrasonik, vending daur ulang & jadwal angkut.", category: "environment", iconName: "Recycle", badge: "Circular" },
  { slug: "pedestrian-bridges", title: "Jembatan Penyeberangan & Terowongan Pedestrian", description: "Jalur penyeberangan multi-level, status eskalator/lift & akses stasiun.", category: "mobility", iconName: "Layers", badge: "Skywalks" },
  { slug: "nightlife-zones", title: "Distrik Ekonomi Malam & 24 Jam Terpadu", description: "Peta zona hiburan malam berizin, keamanan patroli & transit larut malam.", category: "commerce", iconName: "Moon", badge: "24h Economy" },
  { slug: "street-performers", title: "Panggung Seni Jalanan & Mural Publik", description: "Lokasi busking berlisensi, jadwal musisi lokal & jalur wisata grafiti.", category: "commerce", iconName: "Music", badge: "Creative" },
  { slug: "freight-delivery", title: "Pusat Distribusi Cargo Bike Ramah Lingkungan", description: "Hub konsolidasi barang last-mile ramah emisi untuk kawasan pedestrian.", category: "logistics", iconName: "Package", badge: "Zero Emission" },

  // 41-50
  { slug: "airport-express", title: "Hub Intermoda Kereta Bandara & City Check-in", description: "Jadwal express kereta bandara, check-in bagasi kota & integrasi tiket.", category: "mobility", iconName: "PlaneTakeoff", badge: "Airport Link" },
  { slug: "pedestrian-flow-ai", title: "Simulator Dinamika Arus Pejalan Kaki", description: "Model AI antrian, kecepatan langkah & mitigasi penyempitan bottleneck.", category: "smart-city", iconName: "Activity", badge: "Crowd Sim" },
  { slug: "cross-border-tariffs", title: "Kalkulator Tarif Bea Cukai Kerajinan UMKM", description: "Pengecekan kode HS, bea masuk & pembebasan ekspor produk lokal.", category: "commerce", iconName: "FileSpreadsheet", badge: "Cross Border" },
  { slug: "medical-tourism", title: "Koridor Wisata Medis & Faskes Akreditasi", description: "Rumah sakit berstandar internasional, layanan multibahasa & akses transit.", category: "safety", iconName: "Cross", badge: "Healthcare" },
  { slug: "satellite-ndvi", title: "Monitoring Kekeringan Vegetasi NDVI Satelit", description: "Spektrum kehijauan daun Sentinel-2 untuk mitigasi kekeringan pohon kota.", category: "environment", iconName: "Satellite", badge: "NDVI" },
  { slug: "wildlife-corridors", title: "Koridor Lintasan Satwa Liar Urban", description: "Konektivitas kanopi pepohonan penyeberangan burung & fauna kota.", category: "environment", iconName: "Feather", badge: "Ecology" },
  { slug: "sea-level-rise", title: "Simulator Kenaikan Muka Air Laut & Rob", description: "Proyeksi genangan pasang rob laut 0.5m s/d 2.0m & tanggul pengaman.", category: "governance", iconName: "AlertTriangle", badge: "Climate Sim" },
  { slug: "heritage-preservation", title: "Preservasi Fasad Arsitektur Bersejarah", description: "Katalog pelestarian bangunan vernakular, struktur antik & audit gempa.", category: "governance", iconName: "Shield", badge: "Conservation" },
  { slug: "global-embassy", title: "Navigasi Kedutaan & Layanan Konsuler", description: "Lokasi perwakilan diplomatik dunia, hotline darurat WNA & izin visa.", category: "governance", iconName: "Globe", badge: "Diplomatic" },
  { slug: "open-basemaps", title: "Universal Multi-Engine Basemap Switcher", description: "Ganti basemap bebas: OpenStreetMap, Carto Dark/Light, Satelit & Vector.", category: "smart-city", iconName: "Map", badge: "Multi-Basemap" },
];
...
export const CCTV_FEEDS: CctvFeed[] = [
  ...
  { id: "cctv-jkt-01", name: "Bundaran HI MRT South Cam", city: "jakarta", location: "Plaza Indonesia Pedestrian Zone", status: "ONLINE", fps: 30, latencyMs: 45, pedestrianCount: 680, vehicleCount: 240, congestionLevel: "MODERATE", streamType: "simulated_hls" },
...
export const HEAT_ISLAND_ZONES: HeatIslandZone[] = [
  { id: "hi-01", name: "Ginza Asphalt & Glass Canyon", city: "tokyo", surfaceTempC: 39.4, ambientTempC: 31.2, treeCanopyPct: 8, coolingAmenity: "Kipas kabut air halus di stasiun", thermalRisk: "HIGH_STRESS" },
  { id: "hi-02", name: "Gardens by the Bay Biophilic Hub", city: "singapore", surfaceTempC: 28.1, ambientTempC: 28.9, treeCanopyPct: 62, coolingAmenity: "Supertrees & kanopi rimbun", thermalRisk: "COMFORTABLE" },
  { id: "hi-03", name: "Kuningan Epicentrum Concrete Zone", city: "jakarta", surfaceTempC: 41.8, ambientTempC: 33.5, treeCanopyPct: 14, coolingAmenity: "Kanal Rasuna & pohon peneduh", thermalRisk: "EXTREME" },
];
...
export const FLOOD_STATIONS: FloodStation[] = [
  { id: "fl-01", name: "Manggarai Floodgate Telemetry", stationName: "Pintu Air Manggarai", riverOrCanal: "Sungai Ciliwung", city: "jakarta", waterLevelMeters: 670, warningLevelMeters: 750, dangerLevelMeters: 850, status: "NORMAL", trend: "STABLE" },
  { id: "fl-02", name: "Marina Barrage Tidal Gates", stationName: "Marina Catchment Telemetry", riverOrCanal: "Singapore River Basin", city: "singapore", waterLevelMeters: 1.8, warningLevelMeters: 2.8, dangerLevelMeters: 3.5, status: "NORMAL", trend: "RECEDING" },
  { id: "fl-03", name: "Thames Barrier East Gate Sensor", stationName: "Woolwich Reach Monitor", riverOrCanal: "River Thames", city: "london", waterLevelMeters: 3.2, warningLevelMeters: 4.8, dangerLevelMeters: 6.0, status: "NORMAL", trend: "STABLE" },
];
...
export const GTFS_VEHICLES: GtfsVehiclePosition[] = [
  { id: "gtfs-01", routeId: "MRT-NSL-04", headsign: "Jurong East via Woodlands", city: "singapore", nextStop: "Orchard Station", etaMinutes: 2, delaySeconds: 15, congestion: "RUNNING_ON_TIME" },
  { id: "gtfs-02", routeId: "JR-YAMANOTE-22", headsign: "Inner Loop (Shinjuku - Shibuya)", city: "tokyo", nextStop: "Harajuku Station", etaMinutes: 1, delaySeconds: 0, congestion: "RUNNING_ON_TIME" },
  { id: "gtfs-03", routeId: "TJ-CORR-1", headsign: "Blok M -> Kota", city: "jakarta", nextStop: "Halte Tosari ICBC", etaMinutes: 4, delaySeconds: 90, congestion: "SLIGHT_DELAY" },
];
...
export const SATELLITE_NDVI_ZONES: SatelliteNdviZone[] = [
  { id: "ndvi-01", zone: "Monas & Medan Merdeka Green Core", city: "jakarta", meanNdvi: 0.68, droughtStressLevel: "HEALTHY", coolingDeficitCelsius: 1.2 },
  { id: "ndvi-02", zone: "Roppongi Concrete Canyon", city: "tokyo", meanNdvi: 0.18, droughtStressLevel: "SEVERE_STRESS", coolingDeficitCelsius: 4.8 },
];
...
export const SEA_LEVEL_SIMS: SeaLevelRiseSimulation[] = [
  { riseMeters: 0.5, inundatedAreaSqKm: 18.4, affectedPopulation: 145000, criticalAssetsAtRisk: ["Pelabuhan Muara Baru", "Pasar Ikan Luar Batang"], defenseWallStatus: "Tanggul NCICD Tahap A aktif menahan rembesan" },
  { riseMeters: 1.0, inundatedAreaSqKm: 42.1, affectedPopulation: 420000, criticalAssetsAtRisk: ["Kawasan Pergudangan Pluit", "Pintu Air Pasar Ikan", "Jalan Tol Prof. Sedyatmo"], defenseWallStatus: "Dibutuhkan peninggian pompa polder dan seawall terluar" },
  { riseMeters: 2.0, inundatedAreaSqKm: 89.6, affectedPopulation: 1100000, criticalAssetsAtRisk: ["Seluruh pesisir teluk Jakarta tanpa tanggul raksasa"], defenseWallStatus: "Skenario ekstrem mitigasi tanggul laut raksasa NCICD Tahap B" },
];
