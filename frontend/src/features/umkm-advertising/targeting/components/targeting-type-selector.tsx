      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        >
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="break-words font-bold">Sekitar usaha</span>
          </div>
        ...
        >
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="break-words font-bold">Wilayah GETRA</span>
          </div>
          <p className="mt-1 break-words text-xs leading-5 text-gray-500">
            Menjangkau seluruh koridor atau zona yang tersedia di GETRA.
          </p>
        </button>
      </div>
    </div>
