// scripts/verify-cctv-responsive.mjs
...
async function run() {
  console.log('Checking /cctv responsive rendering across 6 viewports...');
  ...
  try {
    ...
    console.log('/cctv Multi-Viewport Responsive Verification: ALL 6 VIEWPORTS PASS');
  } finally {
    await browser.close();
  }
}
