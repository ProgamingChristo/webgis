...
3. Build frontend/backend dari docs/qa/phase10d/compose.yml memakai GETRA_RELEASE_SHA, GETRA_FRONTEND_PORT=3100, GETRA_BACKEND_PORT=8180 dan project getra-hardening.
